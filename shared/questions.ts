...
export const SCORED_QUESTIONS: ScoredQuestion[] = [
  ...
  q({
    ...
    correctAnswer: "4",
    acceptedAnswers: ["4", "4p"],
    explanation: "畫面標示 4P + 8E，所以效能核心為 4 個。",
  ...
  q({
    ...
    prompt: "查看 CPU-Z 底部的核心欄位。",
    correctAnswer: "8",
    acceptedAnswers: ["8", "8e"],
    explanation: "畫面標示 4P + 8E，所以效率核心為 8 個。",
  ...
  q({
    ...
    prompt: "讀取加號前的 4 × 32 KB 並算總量。",
    correctAnswer: "128",
    acceptedAnswers: ["128", "128kb"],
    explanation: "P-core 部分是 4 × 32 KB，所以總容量為 128 KB。",
    mnemonic: "先看每核心，再乘核心數",
    source: "考卷 CPU-Z 看圖題",
    technicalNote: "32 KB 是每顆 P-core 的容量；題目問總容量時要算成 128 KB。",
    unit: "KB",
  }),
  q({
    id: "l7-06",
    ...
    prompt: "讀取加號前的 4 × 1 MB 並算總量。",
    correctAnswer: "4",
    acceptedAnswers: ["4", "4mb"],
    explanation: "P-core 部分是 4 × 1 MB，所以總容量為 4 MB。",
  ...
  q({
    ...
    kind: "hotspot",
    fieldLabel: "L3 快取總容量",
    prompt: "將 16 MB 與 8 MB 相加。",
    correctAnswer: "24",
    acceptedAnswers: ["24", "24mb", "16+8"],
    explanation: "畫面標示 16 MBytes + 8 MBytes，總共 24 MB。",
    mnemonic: "L3 兩群相加",
    source: "考卷 CPU-Z 看圖題",
    unit: "MB",
  }),
